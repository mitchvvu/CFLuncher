...
class StartupPanel(QWidget):
    ...
    def _process_ansi_colors(self, text):
        ...
        # 不在这里处理\r控制字符，因为\r的处理已经在update_log方法中完成
        ...
        def replace_color(match):
            ...
            html_color = color_map.get(color_code, 'black')
